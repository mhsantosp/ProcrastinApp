        ...
        <article className="container home">
          ...
          <div className="row">
            ...
            <div className="col-sm-12 col-md-12 col-lg-7 col-xl-6">
              {/* <Video /> */}
              <iframe className="w-100" height="315" src="https://www.youtube-nocookie.com/embed/FBPI2krmeuw" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </div>
        </article>
      </section>
