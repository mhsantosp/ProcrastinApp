          ...
          <div className="col-9 mt-5">
            <div className="row buttons-1">
              <div className="col">
                ...
                <Link to="/ProcrastinApp/TecnicaPomodoro">
              ...
              <div className="col">
                ...
                <Link to="/ProcrastinApp/Checklist">
              ...
              <div className="col">
                ...
                <Link to="/ProcrastinApp/MasInformacion">
            ...
            <div className="row mt-5 buttons-2">
              <Link to="/ProcrastinApp/Musica" className="col-3 mt-4 mx-5">
                <button className="button-WV">Música</button>
              </Link>
              <Link to="/ProcrastinApp/Podcasts" className="col-3 mt-4 mx-5">
